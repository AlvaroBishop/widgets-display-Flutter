...
class _ListViewBuilderScreenState extends State<ListViewBuilderScreen> {
  ...
  Future fetchData() async
  {
    ...
    if( scrollController.position.pixels + 100 <= scrollController.position.maxScrollExtent) return null;
  ...
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size; // width and height del dispositivo
    return Scaffold(
